...
kill_pi_process() {
  ...
  ssh chengjindu@10.255.32.36 'tmux send-keys -t ros_session C-c'
  ...
  ssh chengjindu@10.255.32.36 'tmux kill-session -t ros_session'
}
...
ssh chengjindu@10.255.32.36 'tmux new-session -d -s ros_session "bash /home/chengjindu/SoftMag/Console/ros_workspace/start_console_pi.sh"' &
